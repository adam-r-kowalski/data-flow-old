...
test("text layout", () => {
    ...
    const expectedLayout = {
        measurements: {
            ...
            textureCoordinates: [
                [
                    0.0625, 0.375, 0.0625, 0.421875, 0.109375, 0.375, 0.109375,
                    0.421875,
                ],
                [
                    0.125, 0.375, 0.125, 0.421875, 0.171875, 0.375, 0.171875,
                    0.421875,
                ],
                [
                    0.1875, 0.375, 0.1875, 0.421875, 0.234375, 0.375, 0.234375,
                    0.421875,
                ],
            ],
        },
...
test("text geometry", () => {
    ...
    const expectedGeometry = {
        ...
        textureCoordinates: [
            ...
            0.125, 0.375, 0.125, 0.421875, 0.171875, 0.375, 0.171875, 0.421875,
            ...
            1: [
                {
                    ...
                    textureIndex: 1,
                    textureCoordinates: [
                        0.0625, 0.375, 0.0625, 0.421875, 0.109375, 0.375,
                        0.109375, 0.421875,

                        0.125, 0.375, 0.125, 0.421875, 0.171875, 0.375,
                        0.171875, 0.421875,

                        0.1875, 0.375, 0.1875, 0.421875, 0.234375, 0.375,
                        0.234375, 0.421875,
                    ],
                    colors: [
...
test("batch geometry with texture change", () => {
    ...
    expect(batches).toEqual([
        ...
        },
        {
            triangles: {
                vertices: [
                    0, 0, 0, 24, 24, 0, 24, 24, 24, 0, 24, 24, 48, 0, 48, 24,
                    48, 0, 48, 24, 72, 0, 72, 24,
                ],
                colors: [
                ...
                textureCoordinates: [
                    0.0625, 0.375, 0.0625, 0.421875, 0.109375, 0.375, 0.109375,
                    0.421875, 0.125, 0.375, 0.125, 0.421875, 0.171875, 0.375,
                    0.171875, 0.421875, 0.1875, 0.375, 0.1875, 0.421875,
                    0.234375, 0.375, 0.234375, 0.421875,
                ],
                cameraIndex: Array(12).fill(0),
            },
            lines: {
